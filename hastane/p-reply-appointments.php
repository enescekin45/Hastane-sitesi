...
<html>
<head>
	<title>Yanıtlanan Randevular <?php echo CONFIG::SİSTEM_ADI; ?></title> <!-- Sayfa başlığı -->
			...
			<div class='col-md-7'>
				<div class='content-area'> 
					...
					<div class='content-body'> 
						<?php Appointment::loadPatientRepliedAppointment();  ?> <!-- Hastanın yanıtladığı randevuları yükleme fonksiyonunu çağır -->
					</div>
				</div> 
			</div>
			<div class='col-md-3'>
